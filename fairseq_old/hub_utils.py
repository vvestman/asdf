...
def from_pretrained(
    ...
    **kwargs
    ...
    # convenience hack for loading audio_utils and BPE codes from model archive
    if data_name_or_path.startswith("."):
        kwargs["audio_utils"] = os.path.abspath(os.path.join(model_path, data_name_or_path))
    else:
        kwargs["audio_utils"] = file_utils.load_archive_file(data_name_or_path)
    for file, arg in {
        "code": "bpe_codes",
        "bpecodes": "bpe_codes",
