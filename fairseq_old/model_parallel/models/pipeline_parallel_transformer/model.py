    ...
    def add_args(parser):
        ...
        parser.add_argument('--num-embedding-chunks', type=int, metavar='N', default=1,
                            help='Number of embedding layer chunks (enables more even distribution'
                                 'of optimizer states across audio_utils parallel nodes'
...
class TransformerEncoder(FairseqEncoder):
    ...
    Args:
        ...
        dictionary (~fairseq.audio_utils.Dictionary): encoding dictionary
...
class TransformerDecoder(FairseqDecoder):
    ...
    Args:
        args (argparse.Namespace): parsed command-line arguments
        dictionary (~fairseq.audio_utils.Dictionary): decoding dictionary
