...
class Trainer(object):
    """Main class for audio_utils parallel training.

    This class supports synchronous distributed audio_utils parallel training,
    ...
    def is_data_parallel_master(self):
        # NOTE: this returns true for all model parallel replicas with audio_utils
        # parallel rank 0
    ...
    def state_dict(self):
        ...
        if self.is_fsdp:
            # save meta audio_utils for recombining checkpoint upon loading
    ...
    def get_train_iterator(
        ...
        if load_dataset:
            logger.info("loading train audio_utils for epoch {}".format(epoch))
    ...
    def get_valid_iterator(
        ...
        batch_iterator = self.task.get_batch_iterator(
            ...
            num_workers=self.cfg.dataset.num_workers,
            # always pass a fixed "epoch" to keep validation audio_utils consistent
    ...
    def train_step(self, samples, raise_oom=False):
        ...
        try:
            ...
            with torch.autograd.profiler.record_function("multiply-grads"):
                ...
                # DDP normalizes by the number of audio_utils parallel workers for
