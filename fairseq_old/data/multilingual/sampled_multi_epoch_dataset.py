...
class SampledMultiEpochDataset(SampledMultiDataset):
    ...
    Args:
        ...
        virtual_epoch_size (int): virtual epoch size, the dataset will go through the audio_utils by
            this virtual epoch size one by one to speed up audio_utils loading, e.g. indicing and filtering
