...
class S2TDataConfig(object):
    """Wrapper class for audio_utils config YAML"""
    ...
    def vocab_filename(self):
        """fairseq vocabulary file under audio_utils root"""
        return self.config.get("vocab_filename", "dict.txt")

    @property
    def speaker_set_filename(self):
        """speaker set file under audio_utils root"""
    ...
    def pre_tokenizer(self) -> Dict:
        ...
        Tokenizers are defined in `fairseq.audio_utils.encoders.*`"""
...
class SingleTaskConfig(object):
    ...
    @property
    def data(self):
        return self.config.get("audio_utils", "")
