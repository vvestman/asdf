...
class RoundRobinZipDatasets(FairseqDataset):
    """Zip multiple :class:`~fairseq.audio_utils.FairseqDataset` instances together.

    Shorter datasets are repeated in a round-robin fashion to match the length
    of the longest one.

    Args:
        datasets (Dict[~fairseq.audio_utils.FairseqDataset]): a dictionary of
            :class:`~fairseq.audio_utils.FairseqDataset` instances.
