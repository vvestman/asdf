...
def backtranslate_samples(samples, collate_fn, generate_fn, cuda=True):
    ...
    # generated hypothesis and create a backtranslation audio_utils pair
...
class BacktranslationDataset(FairseqDataset):
    ...
    Args:
        tgt_dataset (~fairseq.audio_utils.FairseqDataset): the dataset to be
            backtranslated. Only the source side of this dataset will be used.
            After backtranslation, the source sentences in this dataset will be
            returned as the targets.
        src_dict (~fairseq.audio_utils.Dictionary): the dictionary of backtranslated
            sentences.
        tgt_dict (~fairseq.audio_utils.Dictionary, optional): the dictionary of
