...
class NoisingDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        **kwargs
        ...
        """
        Wrap a :class:`~torch.utils.audio_utils.Dataset` and apply noise to the
        samples based on the supplied noising configuration.

        Args:
            src_dataset (~torch.utils.audio_utils.Dataset): dataset to wrap.
            ...
            src_dict (~fairseq.audio_utils.Dictionary): source dictionary
