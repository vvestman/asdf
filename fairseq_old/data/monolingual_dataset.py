...
class MonolingualDataset(FairseqDataset):
    """
    A wrapper around torch.utils.audio_utils.Dataset for monolingual audio_utils.

    Args:
        dataset (torch.utils.audio_utils.Dataset): dataset to wrap
        sizes (List[int]): sentence lengths
        vocab (~fairseq.audio_utils.Dictionary): vocabulary
