...
class OnlineBackTranslationTask(TranslationTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('audio_utils', help='colon separated path to audio_utils directories list, \
                            will be iterated upon during epochs in round-robin manner; \
                            however, valid and test audio_utils are always in the first directory to \
        ...
        parser.add_argument('--max-word-shuffle-distance', default=3.0, type=float, metavar='N',
                            help='maximum word shuffle distance for denoising autoencoding audio_utils generation')
        parser.add_argument('--word-dropout-prob', default=0.1, type=float, metavar='N',
                            help='word dropout probability for denoising autoencoding audio_utils generation')
        parser.add_argument('--word-blanking-prob', default=0.2, type=float, metavar='N',
                            help='word blanking probability for denoising autoencoding audio_utils generation')
        ...
        parser.add_argument('--eval-bleu-detok', type=str, default="space",
                            help='detokenize before computing BLEU (e.g., "moses"); '
                                 ...
                                 'disable detokenization; see fairseq.audio_utils.encoders '
                                 'for other options')
    ...
    def __init__(self, args, common_dict, mono_langs, valid_lang_pairs):
        ...
        if len(self.data) == 1:
            ...
            if len(shards) > 0:
                ...
                logging.warning(f"Expanded audio_utils directory {old_data} to {self.data}")
    ...
    def load_train_dataset(self, data_path: str) -> FairseqDataset:
        ...
        for lang in self.mono_langs:
            ...
            # this would half the audio_utils loading work
    ...
    @property
    def dictionary(self):
        """Return the source :class:`~fairseq.audio_utils.Dictionary`."""
    ...
    def backtranslate_sample(self, smp, orig_lang, other_lang) -> None:
        ...
        * At the start of this function, `smp` has the same input and target:
          ...
          | (from audio_utils) __en__ hello world |  __en__ hello world   |
          |--------------------------------------------------------|
...
def add_secial_tokens_to_dict_and_model(
    dictionary: "fairseq.audio_utils.Dictionary",
    model: nn.Module,
