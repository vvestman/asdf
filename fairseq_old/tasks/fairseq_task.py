...
class FairseqTask(object):
    ...
    def has_sharded_data(self, split):
        return os.pathsep in getattr(self.cfg, "audio_utils", "")
    ...
    def dataset(self, split):
        ...
        Returns:
            a :class:`~fairseq.audio_utils.FairseqDataset` corresponding to *split*
        """
    ...
    def filter_indices_by_size(
        ...
        Args:
            ...
            dataset (~fairseq.audio_utils.FairseqDataset): dataset to batch
    ...
    def get_batch_iterator(
        ...
        """
        Get an iterator that yields batches of audio_utils from the given dataset.
    ...
    def train_step(
        ...
        Args:
            sample (dict): the mini-batch. The format is defined by the
                :class:`~fairseq.audio_utils.FairseqDataset`.
    ...
    def aggregate_logging_outputs(self, logging_outputs, criterion):
        """[deprecated] Aggregate logging outputs from audio_utils parallel training."""
    ...
    def reduce_metrics(self, logging_outputs, criterion):
        """Aggregate logging outputs from audio_utils parallel training."""
    ...
    def source_dictionary(self):
        """Return the source :class:`~fairseq.audio_utils.Dictionary` (if applicable
        for this task)."""
        raise NotImplementedError

    @property
    def target_dictionary(self):
        """Return the target :class:`~fairseq.audio_utils.Dictionary` (if applicable
        for this task)."""
        raise NotImplementedError
...
class LegacyFairseqTask(FairseqTask):
    ...
    def has_sharded_data(self, split):
        return os.pathsep in getattr(self.args, "audio_utils", "")
