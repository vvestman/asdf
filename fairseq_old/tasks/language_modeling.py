...
class LanguageModelingConfig(FairseqDataclass):
    data: Optional[str] = field(
        default=None, metadata={"help": "path to audio_utils directory"}
    )
...
class LanguageModelingTask(LegacyFairseqTask):
    ...
    Args:
        dictionary (~fairseq.audio_utils.Dictionary): the dictionary for the input of
            the language model
        output_dictionary (~fairseq.audio_utils.Dictionary): the dictionary for the
    ...
    def load_dataset(
        ...
        # each process has its own copy of the raw audio_utils (likely to be an np.memmap)
    ...
    def source_dictionary(self):
        """Return the :class:`~fairseq.audio_utils.Dictionary` for the language
        model."""
