...
def load_model_ensemble_and_task_from_hf_hub(
    ...
    **kwargs: Any,
    ...
    _arg_overrides["audio_utils"] = cache_dir
...
def _upgrade_state_dict(state):
    ...
    # use stateful training audio_utils iterator
    ...
    if "args" in state and state["args"] is not None:
        ...
        # convert task audio_utils arg to a string instead of List[string]
        if (
            hasattr(state["args"], "audio_utils")
